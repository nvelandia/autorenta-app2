    ...
    return (
      <Card>
        {!isMobile ? (
          ...
          <CardHeader className="ar-filter-main-title d-flex justify-content-between">
            {translate('step1.result.filterList.mainTitle')}
            <i onClick={this.props.handleClose} className="ar-icon-close-solid ar-light-blue-3-text" />
          </CardHeader>
        )}
        <FilterGroup
